function toggleMode() {
    ...
    if (html.classList.contains("light")) {
        img.setAttribute("alt", "Foto em preto e branco de Andrielli sorrindo.")
    } else {
        img.setAttribute("alt","Foto colorida de Andrielli sorrindo e segurando um Kindle com seu livro na tela.")
    }
}